...
export const dictionaries = {
  en: {
    ...
    detail: {
      ...
      captcha_title: "Verification Required",
      summary: "Summary",
      route: "Route",
  ...
  zh: {
    ...
    home: {
      no_servers: "未配置服务器。请设置 SERVERS 环境变量。",
    ...
    whois: {
      ...
      bogon_asn: "AS{asn} 是 Bogon ASN，属于未分配或保留范围。",
      bogon_ip: "{ip} 是 Bogon IP 地址，属于未分配或保留范围。",
    },
    turnstile: {
      error_unavailable: "CAPTCHA 服务当前不可用。请稍后再试或联系 NOC。",
      verification_failed: "验证失败",
    },
  },
};
